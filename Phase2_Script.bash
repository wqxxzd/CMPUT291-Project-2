...
cat terms.txt | perl break.pl | db_load  -T -t btree te.idx
cat pdates.txt | perl break.pl | db_load  -T -t btree da.idx
cat prices.txt | perl break.pl | db_load  -T -t btree pr.idx
